...
const long MOVEMENT_ENABLE_ENDPOINTS_X_DEFAULT = 1;
const long MOVEMENT_ENABLE_ENDPOINTS_Y_DEFAULT = 1;
const long MOVEMENT_ENABLE_ENDPOINTS_Z_DEFAULT = 1;
...
const long MOVEMENT_MAX_SPD_X_DEFAULT = 3500;
const long MOVEMENT_MAX_SPD_Y_DEFAULT = 3500;
const long MOVEMENT_MAX_SPD_Z_DEFAULT = 3500;
