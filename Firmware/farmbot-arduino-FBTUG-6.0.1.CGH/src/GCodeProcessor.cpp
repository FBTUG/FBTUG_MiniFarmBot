...
long Q = command->getQ();
    ...
    */
    ...
    //pMotionStatus[0] = 1;    //-R1-2018.05.05-CGH
    CurrentState::getInstance()->setMotionStatus(1);    //-2018.05.05
    ...
    if (execution == 0){
        //pMotionStatus[0] = 2;  //-R2-2018.05.05-CGH
        CurrentState::getInstance()->setMotionStatus(2);    //-2018.05.05
        ...
        //pMotionStatus[0] = 3;  //-R3-2018.05.05-CGH
        CurrentState::getInstance()->setMotionStatus(3);    //-2018.05.05
