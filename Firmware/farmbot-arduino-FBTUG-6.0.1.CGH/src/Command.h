...
public: 
  ...
  long getS();    //-2018.03.02???-程式沒寫,double -> long 
  long getA();
  long getB();
  long getC();
...
private:
  ...
  //long axisSpeedValue[3] = {3000, 3000, 3000};    //-2018.03.02-FBTUG
  ...
  long mode = 0;
  long msgQueue = 0;
  long numberWatercapacity = 0;   //-FBTUG-2018.02.24
};
