#include "Board.h"
  ...
  //#define FAN_PIN 9     //-FBTUG-2018.02.24  
  #define FAN_PIN     9   //-FBTUG-2018.02.24-(8)-CGH
  #define WATER_PIN   8   //-FBTUG-2018.02.24-(9)-CGH
  #define VACUUM_PIN  10  //-FBTUG-2018.02.24   
