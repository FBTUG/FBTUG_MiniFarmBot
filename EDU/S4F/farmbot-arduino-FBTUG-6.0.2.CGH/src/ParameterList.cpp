...
int paramVersion = readValueEeprom(0);
    ...
    //paramVersion = 0;         //-2018.02.25-Test Set to Default
...
int ParameterList::readValue(int id)
{
    ...
    if (validParam(id)){
        ...
        Serial.print("R21"); Serial.print(" "); Serial.print("P"); Serial.print(id); Serial.print(" "); Serial.print("V"); Serial.print(value);
        //Serial.print("\r\n");
        
        #ifdef Serial2_Use
          Serial2.print("R21"); Serial2.print(" "); Serial2.print("P"); Serial2.print(id); Serial2.print(" "); Serial2.print("V"); Serial2.print(value);    //-2018.02.25-CGH  
          //Serial2.print("\r\n");    //-2018.02.25-CGH  
        #endif
        ...
        #ifdef Serial2_Use
          Serial2.print("R99 Error: invalid parameter id\r\n");    //-2018.02.25-CGH  
        #endif 
    }
...
void ParameterList::readAllValuesFromEeprom()    //-2018.02.26
{
...
void ParameterList::writeAllValuesToEeprom()    //-2018.02.26
{
    // Write all existing values to eeprom
    for (int i = 0; i < 150; i++){
        if (validParam(i)){
...
void ParameterList::setAllValuesToDefault()   //-2018.02.26
{
...
void ParameterList::loadDefaultValue(int id)
{
    switch (id){
      ...
      case END_STOP_NC_ENABLE:
          ...
          break;
      case Serial2_BaudRate:
          paramValues[id] = Serial2_BaudRate_DEFAULT;   //-鮑率(baud rate)-2018.08.15 - 0.9600, 1.19200, 2.38400, 3.57600, 4.115200
          break;            
      default:
          paramValues[id] = 0;
          break;
...
bool ParameterList::validParam(int id)
{
    ...
    switch (id){
      ...
      //- Added by FBTUG-2018.08.15
      case Serial2_BaudRate:   //-鮑率(baud rate)-2018.08.15 - 0.9600, 1.19200, 2.38400, 3.57600, 4.115200
