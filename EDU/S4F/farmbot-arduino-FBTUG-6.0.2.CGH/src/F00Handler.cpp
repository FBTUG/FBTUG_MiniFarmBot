...
int vFuncCode = 0;
    ...
    //----------------------------------------------------------------
    if(vFuncCode == 5){   //-F00 P5 V0-2018.08.15- 鮑率(baud rate) - 0.9600, 1.19200, 2.38400, 3.57600, 4.115200
        int vBaudRate = 0;
        
        //-2018.08.15 -鮑率(baud rate)- 0.9600, 1.19200, 2.38400, 3.57600, 4.115200 ; Serial2_BaudRate = 250
        //vBaudRate = ParameterList::getInstance()->getValue(Serial2_BaudRate);
        //Serial.print("Old Serial2 BaudRate = "); Serial.println(vBaudRate);
          
        vBaudRate = command->getV();
        ParameterList::getInstance()->writeValue(Serial2_BaudRate, vBaudRate);
      
        //Serial2_BaudRate = 250,   //-鮑率(baud rate)-2018.08.15 - 0.9600, 1.19200, 2.38400, 3.57600, 4.115200

        Serial.print("Serial2 BaudRate = "); Serial.println(vBaudRate);
        #ifdef Serial2_Use
          Serial2.print("Serial2 BaudRate = "); Serial2.println(vBaudRate);
        #endif         
    }
