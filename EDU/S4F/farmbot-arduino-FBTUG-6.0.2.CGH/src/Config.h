...
#define Serial2_Use         //-2018.08.28-FBTUG
//#define BT_Serial2_Use      //-2018.02.25-FBTUG
//#define ESP_Serial2_Use   //-2018.08.08-FBTUG

#define A4988_Resolution 4  //-2018.03.04-FBTUG 1, 2, 4, 8, 16
...
const int PARAM_USE_EEPROM_DEFAULT = 1;       //-2018.03.02-參數取用自EEPROM,要Reset EEPROM,Default參數才有用
...
const int MOVEMENT_KEEP_ACTIVE_Z_DEFAULT = 1;    //-保持ServoON激磁
...
const int MOVEMENT_INVERT_ENDPOINTS_Z_DEFAULT = 1;  //-2018.03.01-FBTUG
...
const int MOVEMENT_INVERT_MOTOR_Z_DEFAULT = 1;      //-2018.03.01-FBTUG
...
//-原廠設定 1Step 1Pulse, 快 16倍 XD 拿精度換速度
const int MOVEMENT_STEP_PER_MM_X_DEFAULT = 5 * A4988_Resolution;    //-2018.03.04-miniFarmbot
const int MOVEMENT_STEP_PER_MM_Y_DEFAULT = 5 * A4988_Resolution;    //-2018.03.04-miniFarmbot
const int MOVEMENT_STEP_PER_MM_Z_DEFAULT = 25 * A4988_Resolution;   //-2018.03.04-miniFarmbot
...
const int MOVEMENT_STEPS_ACC_DEC_X_DEFAULT = 100;   //-2018.03.04-FBTUG-200
const int MOVEMENT_STEPS_ACC_DEC_Y_DEFAULT = 100;   //-2018.03.04-FBTUG-200
const int MOVEMENT_STEPS_ACC_DEC_Z_DEFAULT = 100;   //-2018.03.04-FBTUG-200

// Minimum speed in steps per second
const int MOVEMENT_MIN_SPD_X_DEFAULT = 50 * A4988_Resolution;   //-2018.03.04-FBTUG
const int MOVEMENT_MIN_SPD_Y_DEFAULT = 50 * A4988_Resolution;   //-2018.03.04-FBTUG
const int MOVEMENT_MIN_SPD_Z_DEFAULT = 50 * A4988_Resolution;   //-2018.03.04-FBTUG

// Speed used for homing and calibration
const int MOVEMENT_HOME_SPEED_X_DEFAULT = 50 * A4988_Resolution;  //-2018.03.04-FBTUG
const int MOVEMENT_HOME_SPEED_Y_DEFAULT = 50 * A4988_Resolution;  //-2018.03.04-FBTUG
const int MOVEMENT_HOME_SPEED_Z_DEFAULT = 50 * A4988_Resolution;  //-2018.03.04-FBTUG

const int MOVEMENT_SPD_X_DEFAULT = 220 * A4988_Resolution;   //-2018.03.04-FBTUG-3500
const int MOVEMENT_SPD_Y_DEFAULT = 220 * A4988_Resolution;   //-2018.03.04-FBTUG-3500
const int MOVEMENT_SPD_Z_DEFAULT = 220 * A4988_Resolution;   //-2018.03.04-FBTUG-3500

// Maximum speed in steps per second
const int MOVEMENT_MAX_SPD_X_DEFAULT = 400 * A4988_Resolution;  //-400-2018.03.04-3500-10000
const int MOVEMENT_MAX_SPD_Y_DEFAULT = 400 * A4988_Resolution;  //-400-2018.03.04-3500-10000
const int MOVEMENT_MAX_SPD_Z_DEFAULT = 400 * A4988_Resolution;  //-400-2018.03.04-3500-10000
...
const int Serial2_BaudRate_DEFAULT = 0;   //-鮑率(baud rate)-2018.08.15 - 0.9600, 1.19200, 2.38400, 3.57600, 4.115200
