...
long value = statusValues[id];
    ...
    Serial.print("R31"); Serial.print(" "); Serial.print("P"); Serial.print(id); Serial.print(" "); Serial.print("V"); Serial.print(value);
    //Serial.print("\r\n");
    
    #ifdef Serial2_Use
      Serial2.print("R31"); Serial2.print(" "); Serial2.print("P"); Serial2.print(id); Serial2.print(" "); Serial2.print("V"); Serial2.print(value);
      //Serial2.print("\r\n");    //-2018.02.25-CGH
    #endif
